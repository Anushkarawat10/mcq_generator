...
os.environ["GOOGLE_API_KEY"] = "AIzaSyDpV_EmAdeREpVnooUlTYU4EPVPJ7PE1cY"
...
def Question_mcqs_generator(input_text, num_questions):
    prompt = f"""
    You are an AI assistant helping the user generate multiple-choice questions (MCQs) based on '{input_text}'
    Please generate {num_questions} MCQs from the text, each questions should have:
    -A clear question
